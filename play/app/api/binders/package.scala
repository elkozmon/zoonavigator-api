...
package object binders {
  ...
  implicit def zNodePathBinder(implicit string: QueryStringBindable[String]): QueryStringBindable[ZNodePath] =
    new QueryStringBindable[ZNodePath] {

      override def bind(key: String, params: Map[String, Seq[String]]): Option[Either[String, ZNodePath]] =
        string
          .bind(key, params)
  ...
  implicit def zNodeAclVersionBinder(implicit long: QueryStringBindable[Long]): QueryStringBindable[ZNodeAclVersion] =
    new QueryStringBindable[ZNodeAclVersion] {

      override def bind(key: String, params: Map[String, Seq[String]]): Option[Either[String, ZNodeAclVersion]] =
  ...
  implicit def zNodeDataVersionBinder(implicit long: QueryStringBindable[Long]): QueryStringBindable[ZNodeDataVersion] =
    new QueryStringBindable[ZNodeDataVersion] {

      override def bind(key: String, params: Map[String, Seq[String]]): Option[Either[String, ZNodeDataVersion]] =
